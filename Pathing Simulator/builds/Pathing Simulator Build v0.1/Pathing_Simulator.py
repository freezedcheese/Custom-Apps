...
class VirtualDrivetrain():
    ...
    def setMotorVels(self, v_a, v_b, v_c, v_d):
        self.v_a = v_a if abs(v_a) < self.motorVelCap else self.motorVelCap
        self.v_b = v_b if abs(v_b) < self.motorVelCap else self.motorVelCap
        self.v_c = v_c if abs(v_c) < self.motorVelCap else self.motorVelCap
        self.v_d = v_d if abs(v_d) < self.motorVelCap else self.motorVelCap
